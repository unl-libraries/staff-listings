...
// 	 		$this->xls->getProperties()->setCreator("Stacy Rickel")
// 				->setLastModifiedBy("Stacy Rickel")
// 				->setTitle("UNL Libraries Directory")
// 				->setSubject("UNL Libraries Directory")
// 				->setDescription("UNL Libraries contact information.")
// 				->setKeywords("office 2007 xls excel directory contact")
// 				->setCategory("Test result file");
	...
	public function addTableHeader($data, $params = array()) {
		...
		// font name
		if (array_key_exists('font_name', $params))
	 ...
	 */
	public function output($filename = 'export', $file_extension = 'xlsx') {
